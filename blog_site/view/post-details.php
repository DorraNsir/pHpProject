...
?>
                ...
                <div class="col-lg-12">
                  ...
                  if(isset($_SESSION['username'])):?>
                    <a href="./editPost.php?key=<?php echo $id; ?>">
                  ...
                  <?php endif; ?> 
                      <img src="../assets/uploaded_image/<?php echo $blogposts['image']?>" alt="">
                    </div>
                    <div class="down-content">
                      <span><?php echo $blogposts['title']?></span>
                      <h4><?php echo $blogposts['subject']?></h4>
                      <p ><?php echo $blogposts['description']?></p>
                      <div class="post-options">
                        <p><?php echo $blogposts['created_at']?></p>
                        <div class="row">
                        </div>
                      </div>
                    </div>
